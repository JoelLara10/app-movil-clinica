      ...
      <View style={styles.historyHeader}>
        <View style={styles.historyBadge}>
          <Text style={styles.historyBadgeText}>
            {moment(item.fecha_solicitud).format('DD/MM')}
          </Text>
        </View>
        <View style={styles.historyInfo}>
          <Text style={styles.historyDate}>
            {moment(item.fecha_solicitud).format('dddd, D [de] MMMM [de] YYYY [a las] HH:mm')}
          </Text>
    ...
    <ScrollView style={styles.container}>
      ...
      <LinearGradient colors={['#4299e1', '#3182ce']} style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          <Ionicons name="flask-outline" size={20} color="#fff" /> Exámenes de Laboratorio
        </Text>
        <View style={{ width: 40 }} />
      </LinearGradient>
        ...
        <View style={styles.cardBody}>
                ...
                >
                  <View style={styles.examIcon}>
                    <Ionicons 
                      name="flask-outline" 
                      size={20} 
                      color={selectedExams.includes(exam.id_catalogo) ? "#4299e1" : "#a0aec0"} 
                    />
                  </View>
                  <Text style={[
                    styles.examName,
          ...
          <View style={styles.observacionesSection}>
            ...
            <Text style={styles.helperText}>
              <Ionicons name="information-circle-outline" size={12} /> Puede agregar notas específicas para el laboratorio
            </Text>
          </View>
        </View>
